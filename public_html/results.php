...
?>
    ...
    <head>
        ...
        <meta property="og:url" content="http://quiz.politicalpigeon.media/">
        <meta property="og:image" content="http://quiz.politicalpigeon.media/assets/embedicon.png">
    ...
    <body>
        ...
        <button id="copy" class="large-button" onclick="navigator.clipboard.writeText('/quiz <?php echo $code; ?>');">Copy to clipboard</button>
